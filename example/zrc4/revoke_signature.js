/*
 * revoke signature from a transaction
...
const PRIVATE_KEY = 'd96e9eb5b782a80ea153c937fa83e5948485fbfc8b7e7c069d7b914dbc350aba'; // private key of the signee
const MULTISIG_CONTRACT_ADDR = toBech32Address('0xB9289D96Ee3CC4456ea8911B8a95d5aa939823c1');
const TRANSACTION_ID = '0'; // transaction id to revoke the signature from
...
async function main() {
    try {
        ...
        console.log(`${address}`);
        console.log("------------------------ begin revoke signature ------------------------\n");
    ...
    console.log("------------------------ end revoke signature ------------------------\n");
}
