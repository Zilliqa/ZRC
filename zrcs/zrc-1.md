...
| `token_owner`      | A user (identified by an address) that owns a token tied to a tokenId.                                                                                                                                                           |
| `approved_spender` | A user (identified by an address) that can transfer a token tied to a tokenId on behalf of the `tokenOwner`.                                                                                                                     |
