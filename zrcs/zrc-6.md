...
| `aux_addr_list_batch_burn`          | `List ByStr20`                   | Auxiliary space for [`BatchBurn`](#9-batchburn-optional). It is set to an empty list after the transition. Defaults to empty list.                                                                                                                                                                                                                                                                                                                                                                                       |          |
| `aux_addr_list_batch_transfer_from` | `List ByStr20`                   | Auxiliary space for [`BatchTransferFrom`](#16-batchtransferfrom-optional). It is set to an empty list after the transition. Defaults to empty list.                                                                                                                                                                                                                                                                                                                                                                      |          |
...
|              | Name        | Description                       | Event Parameters                                                                                                                                                                                     |
| ------------ | ----------- | --------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `_eventname` | `BatchBurn` | Multiple tokens have been burned. | <ul><li>`token_id_list` : `List Uint256`<br/>List of unique IDs of the NFT to be destroyed</li><li>`token_owner_list` : `List ByStr20`<br/>List of token owners of the NFT to be destroyed</li></ul> |
...
|              | Name                | Description                            | Event Parameters                                                                                                                                                                                                                                                                                                                              |
| ------------ | ------------------- | -------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `_eventname` | `BatchTransferFrom` | Multiple tokens have been transferred. | <ul><li>`from_list` : `List ByStr20`<br/>List of token owner of the NFT to be transferred</li><li>`to_token_id_pair_list` : `List (Pair ByStr20 Uint256)` <br/><br/> List of Pair (`to`, `token_id`)<br/><br/><ul><li>`to` : `ByStr20`<br/>Address of a recipient</li><li>`token_id` : `Uint256`<br/>Unique ID of a token</li></ul></li></ul> |
