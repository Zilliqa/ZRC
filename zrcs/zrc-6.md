...
| 6   | Standard for Non Fungible Tokens | Draft  | Standard | Nines Duck <duck@duck.community> <br>                                                                       | 2021-09-04           | 2021-09-04           |
...
ZRC-1 was depreciated for ZRC-6 due to callbacks having unique transition names between ZRC-1 and ZRC-2, this caused composed contracts to throw a compiler error. 
ZRC-6 defines a minimum interface a smart contract must implement to allow unique tokens to be managed, tracked, owned, and traded.
